...
VIRTUSER_DOMAIN(`resmail.st5.os3.su')dnl
...
DAEMON_OPTIONS(`Family=inet,  Port=smtp, Addr=188.130.155.38, Name=MTA-v4')dnl
...
MAILER(`local')dnl
MAILER(`smtp')dnl
INPUT_MAIL_FILTER(`opendkim', `S=inet:23412@localhost')dnl
